...
* Validating the outgoing Business Document (hence it depends on the used AES-System) for details see: link:{basepath}/doc/architecture/ecodex_container_creation.html[e-Codex Container Creation]
