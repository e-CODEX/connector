...
class SignatureUtils {
    public static void main(String[] args) throws FileNotFoundException, SAXException, IOException,
            ParserConfigurationException, TransformerException, DatatypeConfigurationException, JAXBException {
        // //
        // SignatureUtils.signEnveloped("D:\\git\\ecodex_evidences\\EvidencesModel\\src\\test\\resources
        // \\SubmissionAcceptance.xsd");
    ...
    public static void signEnveloped(String documentToBeSigned) {
        ...
        try {
            ...
            String extension = FilenameUtils.getExtension(documentToBeSigned);
            os =
                    new FileOutputStream(FilenameUtils.getFullPath(documentToBeSigned) + filename + "_signed." + extension);

            TransformerFactory tf = TransformerFactory.newInstance();
            Transformer trans = tf.newTransformer();
            trans.transform(new DOMSource(doc), new StreamResult(os));
        } catch (SAXException | KeyException | InvalidAlgorithmParameterException | NoSuchAlgorithmException |
                 XMLSignatureException | MarshalException | TransformerException | ParserConfigurationException |
                 IOException e) {
    ...
    public static byte[] signByteArray(byte[] xmlData) {
        ...
        try {
            ...
            // OutputStream os;
            // os = new
            // FileOutputStream("D:\\git\\ecodex_evidences\\EvidencesModel\\src\\test\\resources
            // \\SubmissionAcceptance_signed.xsd");
            //
            // TransformerFactory tf = TransformerFactory.newInstance();
            // Transformer trans = tf.newTransformer();
            // trans.transform(new DOMSource(doc), new StreamResult(os));
    ...
    public static JAXBElement<REMEvidenceType> signEvidence(
        ...
        try {
            ...
            JaxbContextHolder.getSpocsJaxBContext().createMarshaller()
                             .marshal(
                                     new ObjectFactory().createSubmissionAcceptanceRejection(evidence),
                                     unsignedDOMDocument
                             );
    ...
    private static KeyPair getKeyPairFromKeyStore(String store, String storePass, String alias, String keyPass) {
        KeyStore ks;
    ...
    private SubmissionAcceptanceRejection createSubmissionAcceptance() throws DatatypeConfigurationException,
            JAXBException, MalformedURLException, FileNotFoundException {
