...
import static eu.spocseu.common.SpocsConstants.COUNTRY_CODES.*;

public class SpocsConstants
{
	public static QName SPOCS_SERVICE_QNAME = new QName(
		"http://spocsinterconnect.gateway.eu", "GatewayService");

	public static enum E_ADDRESS_SCHEMES
	{
		RFC5322ADDRESS("RFC5322-Address"), BUSDOX("busdox-actorid-upis");
		private String specName;

		private E_ADDRESS_SCHEMES(String spec)
		{
			specName = spec;
		}
	...
	public static enum AUTHENTICATION_LEVEL
	{
		LEVEL_1("1"), LEVEL_2("2");
		private String specName;

		private AUTHENTICATION_LEVEL(String spec)
		{
			specName = spec;
		}
	...
	public static enum ActorRole
	{
		...
		private ActorRole(String _name)
		{
			name = _name;
		}
	...
	public enum Evidences
	{
		...
		private Evidences(String _name, String _successEventCode,
				String _faultEventCode)
		{
			name = _name;
		...
		public static Evidences valueOfElementName(String elementName)
		{
			...
			throw new IllegalArgumentException(
				"wrong elemen name did not found the element: " + elementName);
		}
	}

	public static enum COUNTRY_CODES
	{
		GERMANY("DE", "Germany"),
		AUSTRIA("AT", "Austria"),
		BELGIUM("BE", "Belgium"),
		...
		private COUNTRY_CODES(String _code, String _name)
		{
			code = _code;
			name = _name;
		 ...
		 * 
		 * @param country
		 *            The code, the country name or the countryCode values to
	...
	// private enum Event {
	// SUBMISSION_ACCEPTANCE("SubmissionAcceptance"), SUBMISSION_REJECTION(
	// "SubmissionRejection"), RELAY_TO_REM_MD_ACCEPTANCE(
	// "RelayToREMMDAcceptance"), RELAY_TO_REM_MD_REJECTION(
	// "RelayToREMMDRejection"), RELAY_TO_REM_MD_FAILURE(
	// "RelayToREMMDFailure"), DELIVERY_TO_RECIPIENT(
	// "DeliveryToRecipient"), NON_DELIVERY_TO_RECIPIENT(
	// "NonDeliveryToRecipient"), RETRIEVAL_BY_RECIPIENT(
	// "RetrievalByRecipient"), NON_RETRIEVAL_BY_RECIPIENT(
	// "NonRetrievalByRecipient"), ACCEPTANCE_BY_RECIPIENT(
	// "AcceptanceByRecipient"), REJECTION_BY_RECIPIENT(
	// "RejectionByRecipient"), RECEIVED_BY_NON_REM_SYSTEM(
	// "ReceivedByNonREMSystem");
	// private String name;
	//
	// private Event(String _name) {
	// name = _name;
	// }
	//
	// public String getName() {
