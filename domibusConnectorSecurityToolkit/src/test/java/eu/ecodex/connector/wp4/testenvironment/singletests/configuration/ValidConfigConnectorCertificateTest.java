...
public class ValidConfigConnectorCertificateTest {
    ...
    //
    //     containerService.setContainerSignatureParameters(
    //         ValidConfig_SignatureParameters.getPKCS12Configuration());
    //
    //     BusinessContent content = ValidConfig_BusinessContent.get_UnsignedFile_WithoutAttachments();
    //     TokenIssuer issuer = ValidConfig_TokenIssuer.get_FullAuthenticationBased();
    //
    ...
    //
    // /**
    //  * In case of failure the reason could be that "JKS" is not the default keystore type of the
    //  * Java VM
    //  *
    //  * @throws Exception
    //  */
    ...
    //
    // /**
    //  * This test is optional! In case of failure the reason could be that "PKCS12" is not the
    //  * default keystore type of the Java VM
    //  *
    //  * @throws Exception
    //  */
    ...
    //     try {
    //         containerService.setContainerSignatureParameters(
    //             ValidConfig_SignatureParameters.getPKCS12Config_By_SigParamFactory());
    //     } catch (IOException ex) {
    //         Assertions.fail(
    //             "This test is optional! The usage of PKCS12 keystores only works with PKCS12 being the default keystore type within the used Java VM.",
    //             ex
    //         );
    //     }
    //
    ...
    //
    //     containerService.setContainerSignatureParameters(
    //         ValidConfig_SignatureParameters.getJKSConfiguration_SHA256());
    //
    //     BusinessContent content = ValidConfig_BusinessContent.get_UnsignedFile_WithoutAttachments();
    //     TokenIssuer issuer = ValidConfig_TokenIssuer.get_FullAuthenticationBased();
    //
    ...
    //
    //     containerService.setContainerSignatureParameters(
    //         ValidConfig_SignatureParameters.getJKSConfiguration_SHA512());
    //
    //     BusinessContent content = ValidConfig_BusinessContent.get_UnsignedFile_WithoutAttachments();
    //     TokenIssuer issuer = ValidConfig_TokenIssuer.get_FullAuthenticationBased();
    //
