...
class DSSEcodexContainerServiceTest {
    ...
    private DSSECodexContainerService initContainerService() throws Exception {
        DSSECodexContainerService containerService =
                null; // new DSSECodexContainerService(technicalValidationService, legalValidationService,
        ...
        //        DSSECodexTechnicalValidationService technicalValidationService = new
        //        DSSECodexTechnicalValidationService(certificateVerifier, processExecutor,
        //        trustedListCertificatesSource, ignoredCertificatesStore);
        ...
        SignatureParameters signingParameters = SignatureParametersFactory.create(certStore,
                                                                                  keyAlias,
                                                                                  keyPassword,
                                                                                  encryptionAlgorithm,
                                                                                  digestAlgorithm
