...
@SpringBootTest(
        classes = {MoveMessagesFromDlqToQueueTest.MyTestContext.class}, properties = {"spring.liquibase.enabled=false"}
)
...
class MoveMessagesFromDlqToQueueTest {
    ...
    @Test
    void it_is_possible_to_move_a_message_from_the_dlq_back_to_the_queue() throws JMSException {
        // Arrange
