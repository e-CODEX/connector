...
For more details about the payload handling see: link:../architecture/payload_handling.html#payload-handling[Payload Handling]
...
connector.persistence.default-large-file-provider-class=eu.ecodex.connector.persistence.largefiles.provider.LargeFilePersistenceServiceFilesystemImpl
----
...
connector.persistence.default-large-file-provider-class=eu.ecodex.connector.persistence.largefiles.provider.LargeFilePersistenceServiceJpaImpl
----
