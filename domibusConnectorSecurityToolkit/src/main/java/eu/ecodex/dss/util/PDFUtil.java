...
public class PDFUtil {
     ...
     */
    public static com.lowagie.text.Font createFont(
            final Font font,
            final int size) throws IOException, DocumentException {
    ...
    public static com.lowagie.text.Font createFont(
        ...
        final BaseFont baseFont =
                BaseFont.createFont(name, BaseFont.WINANSI, BaseFont.EMBEDDED, BaseFont.CACHED, data, null);
     ...
     * @throws java.io.IOException                The {@link java.io.IOException} if all document are empty or one of
     *                                            them is not a PDF.
     * @throws com.lowagie.text.DocumentException as of the underlying classes
     */
    public static DSSDocument concatenate(
            final String filename,
            final DSSDocument... documents) throws IOException, DocumentException {
        ...
        for (final DSSDocument doc : documents) {
            ...
            try {
                ...
                throw new IOException("The document '" + doc.getName() + "' with mime-type '" + doc.getMimeType() +
                                              "'" +
                                              " is not a PDF file");
            }
        }
            ...
            for (final PdfReader sourceReader : sourceReaders) {
                ...
                while (importedPagesCount < sourceReaderCount) {
                    ...
                    targetContent.showTextAligned(
                            ...
                            targetCurrentCount + " of " + targetTotalCount,
                            520,
                            5,
                            0
                    );
