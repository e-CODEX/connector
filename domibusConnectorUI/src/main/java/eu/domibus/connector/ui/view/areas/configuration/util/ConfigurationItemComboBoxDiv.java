...
public class ConfigurationItemComboBoxDiv extends ConfigurationItemDiv {
	...
	public ConfigurationItemComboBoxDiv(ComboBox<String> comboBox, ConfigurationLabel labels, Collection<String> items, String initialValue, ConfigurationProperties configurationProperties) {
