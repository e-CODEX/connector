...
This document describes how these links are configured with properties. The UI configuration manual is link:{basepath}/doc/ui/configuration/link_configuration.html[here] available.

The general architecture of the link is link:{basepath}/doc/architecture/link_partners.html[here] available.
