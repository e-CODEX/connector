...
public class ValidConfig_BusinessContent {
	...
	private static String Path_UnsignedFile = "src/test/resources/documents/Unsigned.xml";
	...
	private static String Path_SignedFile = "src/test/resources/documents/One_Sig_New.pdf";
	private static String Path_Unsupported_SignedFile = "src/test/resources/documents/business_document_with_unsupported_signature.xml";
//	private static String Path_Detached_Signature = "src/test/resources/documents/e-CODEX D4.9 Developed Modules and Building Blocks_v1.pdf.pkcs7";
//	private static String Path_Detached_SignedFile = "src/test/resources/documents/e-CODEX D4.9 Developed Modules and Building Blocks_v1.pdf";
	private static String Path_Detached_Signature = "src/test/resources/documents/Test_Data.xml.pkcs7";
	private static String Path_Detached_SignedFile = "src/test/resources/documents/Test_Data.xml";
//	private static String Path_MultisignedFile = "src/test/resources/documents/Two_Sig.pdf";
	private static String Path_MultisignedFile = "src/test/resources/documents/Evidence_workflow_Multisigned.pdf";
	private static String Path_MultisignedFile_One_Invalid = "src/test/resources/documents/Two_Sig-One_Invalid.pdf";
