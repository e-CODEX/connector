 ...
 *
 * $HeadURL: http://forge.aris-lux.lan/svn/dgmarktdss/ecodex/container/tags/ecodex-container-DSS-library-2.5.0
 * .3/apps/dss/dss-report/src/main/java/eu/europa/ec/markt/dss/report/PdfValidationReportService.java $
 * $Revision: 2149 $
...
public class PdfValidationReportService {
    ...
    public void createReport(
            ...
            OutputStream pdfStream) throws IOException {
    ...
    private void writeSignatureInformation(
        ...
        for (String certificateId : signatureCertificateChain) {
            final boolean validCertificate = diagnosticData
                    .getCertificateRevocationStatus(certificateId)
                    .isGood(); // isValidCertificate(certificateId);
            if (!validCertificate) {
                valid = false;
                break;
            }
        ...
        document.add(p("The signature is: " + simpleReport.getSignatureQualification(signatureId)
                                                          .name())); // getSignatureLevel(signatureId).name()));
    }
    ...
    private void writeLevelEPES(
            final Document document,
            String signatureId,
            final DiagnosticData diagnosticData) throws DocumentException {
    ...
    private void writeTimestampResultInformation(
            ...
            DiagnosticData diagnosticData) throws DocumentException {
    ...
    private static final class Resources {
        ...
        static {
            try {
                ...
                koImage = Image.getInstance(
                        ImageIO.read(PdfValidationReportService.class.getResourceAsStream("/error.jpg")),
                        null
                );
