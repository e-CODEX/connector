...
const Re = "copilot-", ts = "24.4.10", Dl = "attention-required", Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
  const t = [];
  let r = is(e);
  for (; r; )
...
function Vs() {
  ve.push(import("./copilot-log-plugin-BLgLu7Kf.js")), ve.push(import("./copilot-info-plugin-DHs50QZ6.js")), ve.push(import("./copilot-features-plugin-Bt7MtkoD.js")), ve.push(import("./copilot-feedback-plugin-COEG4uWz.js")), ve.push(import("./copilot-shortcuts-plugin-BLjGcRTW.js"));
}
function js() {
  {
...
const Ot = new ks(), $ = window.Vaadin.copilot.eventbus;
if (!$)
...
const Ls = Wi(Or);
function Xi() {
  return import("./copilot-notification-BA0bxeqW.js");
}
const Ms = (e) => {
...
let xn = class extends Ts {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-DoBmT6qT.js"), await import("./copilot-init-step2-DrFdUBNE.js"), Vs(), this.tabIndex = 0, Ot.hostConnectedCallback(), window.addEventListener("keydown", wn), $.onSend(this.handleSendEvent), this.removers.push($.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
   ...
   */
  activate() {
    Ur("activate"), Ot.activate(), Nn.copilotActivated(), Rs(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), qe.onCopilotActivation(), $.emit("component-tree-updated", {}), Zi.loadPreviewConfiguration();
  }
  /**
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), Ot.hostDisconnectedCallback(), window.removeEventListener("keydown", wn), $.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), qe.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
