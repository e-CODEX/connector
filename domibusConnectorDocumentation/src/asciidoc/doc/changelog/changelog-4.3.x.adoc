...
Upgrade manual: link:{basepath}/doc/upgrade/upgrade-4.3.0.html[Upgrade to 4.3.0]
...
* New DB Scripts for (please also consult the test-matrix: link:{basepath}/doc/versioning_and_compatibility/testing_matrix.html[Test Matrix]), (higher Major Versions might work)
** MariaDB 10.3
** Postgresql >= 13.2
** Mysql 8, >= 5.6.6
** Oracle 11g
