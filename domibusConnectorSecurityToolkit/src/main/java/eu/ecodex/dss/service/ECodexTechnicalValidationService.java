...
//    void setEnvironmentConfiguration(final EnvironmentConfiguration conf);
     ...
     * 
     * @param businessDocument the document for which a validation = trust has to be created; this may be signed or not
     ...
     */
    TokenValidation create(final DSSDocument businessDocument, final DSSDocument detachedSignature) throws ECodexException;
