...
/**
 * This class represent a AcceptanceRejectionByRecipient evidence. It helps to create the underlying
...
public class AcceptanceRejectionByRecipient extends Evidence {
    ...
    /**
     * This constructor creates this AcceptanceRejectionByRecipient evidence with the given JAXB
    ...
    /**
     * This constructor creates a AcceptanceRejectionByRecipient object based on a previous
     * RelayREMMDAcceptanceRejection evidence.
     *
    ...
    /**
     * This constructor creates a RejectionByRecipient (false) evidence based on a previous
    ...
    /**
     * This constructor can be used to parse a serialized AcceptanceRejectionByRecipient xml stream
    ...
    public AcceptanceRejectionByRecipient(
        EDeliveryDetails details,
        InputStream evidenceStream, Evidences typeOfInputStream)
    ...
    /**
     * Initializes the AcceptanceRejectionByRecipient evidence with the given details, previous
     * evidence, and acceptance status.
     *
     * @param details          The configuration object that sets some properties.
     * @param previousEvidence The previous evidence.
     * @param isAcceptance     The acceptance status.
     */
    private void init(
    ...
    public void serialize(OutputStream out) throws JAXBException {
        JaxbContextHolder
            ...
            .createMarshaller()
            .marshal(
                new ObjectFactory().createAcceptanceRejectionByRecipient(jaxbObj), out
            );
    }
