...
public class Info extends VerticalLayout implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        storagePath.setValue(env.getProperty(PROPERTY_FILESYSTEM_PATH) != null ? env.getProperty(
                PROPERTY_FILESYSTEM_PATH) : "");
        createDirs.setValue(env.getProperty(PROPERTY_CREATE_DIRS) != null ? Boolean.valueOf(env.getProperty(
                PROPERTY_CREATE_DIRS)) : false);

        useHttpProxyBox.setValue(env.getProperty(PROPERTY_USE_HTTP_PROXY) != null ? Boolean.valueOf(env.getProperty(
                PROPERTY_USE_HTTP_PROXY)) : false);
        httpProxyHostField.setValue(env.getProperty(PROPERTY_HTTP_PROXY_HOST) != null ? env.getProperty(
                PROPERTY_HTTP_PROXY_HOST) : "");
        httpProxyPortField.setValue(env.getProperty(PROPERTY_HTTP_PROXY_PORT) != null ? env.getProperty(
                PROPERTY_HTTP_PROXY_PORT) : "");
        httpProxyUserField.setValue(env.getProperty(PROPERTY_HTTP_PROXY_USER) != null ? env.getProperty(
                PROPERTY_HTTP_PROXY_USER) : "");
        httpProxyPasswordField.setValue(env.getProperty(PROPERTY_HTTP_PROXY_PASS) != null ? env.getProperty(
                PROPERTY_HTTP_PROXY_PASS) : "");

        useHttpsProxyBox.setValue(env.getProperty(PROPERTY_USE_HTTPS_PROXY) != null ? Boolean.valueOf(env.getProperty(
                PROPERTY_USE_HTTPS_PROXY)) : false);
        httpsProxyHostField.setValue(env.getProperty(PROPERTY_HTTPS_PROXY_HOST) != null ? env.getProperty(
                PROPERTY_HTTPS_PROXY_HOST) : "");
        httpsProxyPortField.setValue(env.getProperty(PROPERTY_HTTPS_PROXY_PORT) != null ? env.getProperty(
                PROPERTY_HTTPS_PROXY_PORT) : "");
        httpsProxyUserField.setValue(env.getProperty(PROPERTY_HTTPS_PROXY_USER) != null ? env.getProperty(
                PROPERTY_HTTPS_PROXY_USER) : "");
        httpsProxyPasswordField.setValue(env.getProperty(PROPERTY_HTTPS_PROXY_PASS) != null ? env.getProperty(
                PROPERTY_HTTPS_PROXY_PASS) : "");
    }
}
