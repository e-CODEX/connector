...
=== Actuator Security
The actuator interface is located under <connectorURL>/actuator and is password protected. To access the
...
NOTE: A preview on the health metrics is here link:https://scm.ecodex.eu/artifactory/libs-release/eu/ecodex/utils/monitor/ecodex-monitor-app/0.0.12-RELEASE/[]
