 ...
 *
 * $HeadURL: http://forge.aris-lux.lan/svn/dgmarktdss/ecodex/src/main/java/eu/ecodex/dss/service/checks/ECodexContainerChecker.java $
 * $Revision: 1879 $
...
public class ECodexContainerChecker extends AbstractChecker<ECodexContainer> {
                ...
                if (atts == null && cert == null && time == null && sig.size() == 1) {
	                ...
	                if (isMissing(cert)) {
						...
						if (isMissing(cert.getIssuer())) {
							detect(r, false, Findings.TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_CERTINFO_ISSUER_MISSING);
						}
					}
					...
					if (isMissing(atts)) {
						...
						if (isMissing(atts.getSignatureFormat())) {
							detect(r, false, Findings.TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_SIGINFO_FORMAT_MISSING);
						}
     ...
     */
    public static interface Findings {
        ...
        String TOKEN_DOCUMENT_MISSING = "the eCodexContainer's token object must not have a null/empty document object";
        String TOKEN_DOCUMENT_FILENAME_MISSING = "the eCodexContainer's token document object must not have a null/empty filename";
        String TOKEN_DOCUMENT_TYPE_MISSING = "the eCodexContainer's token document object must not have a null/empty type";
        String TOKEN_DOCUMENT_DIGESTMETHOD_MISSING = "the eCodexContainer's token document object must not have a null/empty digestmethod";
        String TOKEN_DOCUMENT_DIGESTVALUE_MISSING = "the eCodexContainer's token document object must not have a null/empty digestvalue";
        String TOKEN_VALIDATION_MISSING = "the eCodexContainer's token object must not have a null/empty validation object";
        String TOKEN_VALIDATION_TIME_MISSING = "the eCodexContainer's token validation object must not have a null/empty verificationtime object";
        String TOKEN_VALIDATION_TECHNICAL_RESULT_MISSING = "the eCodexContainer's token validation object must not have a null/empty technical result object";
        String TOKEN_VALIDATION_TECHNICAL_RESULT_TRUSTLEVEL_MISSING = "the eCodexContainer's token technical validationresult object must not have a null/empty trustlevel object";
        String TOKEN_VALIDATION_TECHNICAL_RESULT_COMMENT_MISSING = "the eCodexContainer's token technical validationresult object should not have a null/empty comment, if the trustlevel is not SUCCESSFUL";
        String TOKEN_VALIDATION_LEGAL_RESULT_MISSING = "the eCodexContainer's token validation object must not have a null/empty legal result object";
        String TOKEN_VALIDATION_LEGAL_RESULT_TRUSTLEVEL_MISSING = "the eCodexContainer's token legal validationresult object must not have a null/empty trustlevel object";
        String TOKEN_VALIDATION_LEGAL_RESULT_DISCLAIMER_MISSING = "the eCodexContainer's token legal validationresult object should not have a null/empty disclaimer";
        String TOKEN_ISSUER_MISSING = "the eCodexContainer's token object must not have a null/empty issuer object";
        String TOKEN_ISSUER_SYSTEMTYPE_MISSING = "the eCodexContainer's token issuer object must not have a null/empty advancedsystemtype object";
        String TOKEN_VALIDATION_VERIFICATIONDATA_MISSING = "the eCodexContainer's token object must not have a null/empty validationverification object";
        String TOKEN_VALIDATION_VERIFICATIONDATA_AUTHINFO_MISSING = "the eCodexContainer's token object must not have a null/empty authenticationinformation object, if the system is AUTHENTICATION_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_AUTHINFO_USERNAME_MISSING = "the eCodexContainer's token authenticationinformation object should not have a null/empty usernamesynonym, if the system is AUTHENTICATION_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_AUTHINFO_IDENTITYPROVIDER_MISSING = "the eCodexContainer's token authenticationinformation object should not have a null/empty identityprovider, if the system is AUTHENTICATION_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_AUTHINFO_TIME_MISSING = "the eCodexContainer's token authenticationinformation object should not have a null/empty timeofauthentication, if the system is AUTHENTICATION_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_MISSING = "the eCodexContainer's token object must not have a null/empty signature object, if the system is SIGNATURE_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_CERTINFO_MISSING = "the eCodexContainer's token signature object must not have a null/empty signaturecertificate object, if the system is SIGNATURE_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_CERTINFO_ISSUER_MISSING = "the eCodexContainer's token signaturecertificate object should not have a null/empty issuer object, if the system is SIGNATURE_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_SIGINFO_MISSING = "the eCodexContainer's token signature object must not have a null/empty signatureattributes object, if the system is SIGNATURE_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_SIGINFO_FORMAT_MISSING = "the eCodexContainer's token signatureattributes object should not have a null/empty signatureformat object, if the system is SIGNATURE_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_SIGINFO_LEVEL_MISSING = "the eCodexContainer's token signatureattributes object should not have a null/empty signaturelevel object, if the system is SIGNATURE_BASED";
        String TOKEN_VALIDATION_VERIFICATIONDATA_SIGDATA_TIME_MISSING = "the eCodexContainer's token signature object must not have a null/empty signingTime object, if the system is SIGNATURE_BASED";
        ...
        String CONTAINER_SIGNATURE_DATA_MISSING = "the eCodexContainer must not have a null/empty detached signature data stream";
        String CONTAINER_TOKENPDF_MISSING = "the eCodexContainer must not have a null/empty token PDF document";
        String CONTAINER_TOKENPDF_DATA_MISSING = "the eCodexContainer must not have a null/empty token PDF data stream";
        String CONTAINER_TOKENXML_MISSING = "the eCodexContainer must not have a null/empty token XML document";
        String CONTAINER_TOKENXML_DATA_MISSING = "the eCodexContainer must not have a null/empty token XML data stream";
    }
}