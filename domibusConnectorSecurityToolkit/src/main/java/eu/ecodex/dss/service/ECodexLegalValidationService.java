...
/**
 * <p>the contract about creating the legal validation (result and report) on the {@link Token}, specifically on its {@link TokenValidation}</p> 
 * <p>this can be either a national implementation or the one of the DSS library</p>
 * <p>this class is called as a delegate by the DSS implementation of the {@link eu.ecodex.dss.service.ECodexContainerService}.</p>
