...
* Validating the outgoing Business Document (hence it depends on the used AES-System) for details see: link:../architecture/ecodex_container_creation.html#ecodex-container-creation[e-Codex Container Creation]
...
* Signing the TrustToken (see: link:../architecture/ecodex_container_creation.html[eCodex container creation])
* Signing the outgoing ASIC-S container (see: link:../architecture/ecodex_container_creation.html#ecodex-container-creation[eCodex container creation])
