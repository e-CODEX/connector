...
/**
 * The SecurityConfigurationLabels class represents a collection of static final ConfigurationLabel
 * objects used for configuring security settings.
 */
@UtilityClass
public class SecurityConfigurationLabels {
    ...
    public static final ConfigurationLabel tokenIssuerServiceProviderLabels =
    ...
    public static final ConfigurationLabel tokenIssuerAESValueLabels = new ConfigurationLabel(
        ...
        "This value indicates whether the main documents used in messages are already "
            + "signed by the backend or not. ",
        "Values:",
        "SIGNATURE_BASED: The main document is signed. The signature is validated by the "
            + "connector using the certificate which has to be in the truststore. ",
        "AUTHENTICATION_BASED: The main document is NOT signed and comes from an advanced system "
            + "that is in the same closed network as the connector is."
    );
    ...
    public static final ConfigurationLabel securityKeyStorePathLabels = new ConfigurationLabel(
        ...
        "The File-Path to the keystore holding the certificate with which the built "
            + "secure container (ASIC-S) is signed. ",
    ...
    public static final ConfigurationLabel securityKeyStorePasswordLabels = new ConfigurationLabel(
        ...
        "The Password of the keystore holding the certificate with which the built "
            + "secure container (ASIC-S) is signed. "
    );
    public static final ConfigurationLabel securityKeyAliasLabels = new ConfigurationLabel(
        "Signing Key Alias",
        "connector.security.private-key.alias",
        "The alias of the private key with which the built secure container (ASIC-S) is "
            + "signed. "
    );
    public static final ConfigurationLabel securityKeyPasswordLabels = new ConfigurationLabel(
        ...
        "The Password of the private key with which the built secure container (ASIC-S) "
            + "is signed. "
    );
    public static final ConfigurationLabel securityTrustStorePathLabels = new ConfigurationLabel(
        ...
        "The File-Path to the truststore holding all public certificates of partners. "
            + "When receiving a message the connector validates the ",
        "signature of the secure container (ASIC-S) by using the certificates in this store.",
        "The path ideally should be absolute and with a \"file:\" prefix. Also \"\\\" should be "
            + "replaced by \"/\" or \"\\\\\"",
        "Example: file:C:/<anyPath>/connector.jks"
    );
    public static final ConfigurationLabel securityTrustStorePasswordLabels =
        new ConfigurationLabel(
            "Truststore Password",
            "connector.security.trust-store.password",
            "The Password of the truststore holding the certificates with which the "
                + "built secure container's signature can be validated. "
        );
}
