...
public class ValidConfig_CertificateVerifier {
    ...
    public static CommonCertificateVerifier get_WithProxy() throws IOException {
        if (verifierVariant1 == null) {
            ...
            KeyStoreCertificateSource keyStoreCertificateSource =
                    new KeyStoreCertificateSource(new File("src/test/resources/keystores/signature_store.jks"),
                                                  "JKS",
                                                  "teststore"
                    );
    ...
    public static CommonCertificateVerifier get_NoProxy() throws IOException {
        if (verifierVariant2 == null) {
            ...
            KeyStoreCertificateSource keyStoreCertificateSource =
                    new KeyStoreCertificateSource(new ClassPathResource("/keystores/keystore.jks").getInputStream(),
                                                  "JKS",
                                                  "test123"
                    );
