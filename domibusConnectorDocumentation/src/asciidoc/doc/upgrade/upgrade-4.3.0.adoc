...
link:../configuration/link_doc.html#connector-link-plugins[Connector Link Manual]
...
For details see: link:../architecture/backend_message_routing.html#backend-message-routing[Backend Message Routing]
...
If you are using oracle, please use a JDBC driver which is XA compliant, this means
