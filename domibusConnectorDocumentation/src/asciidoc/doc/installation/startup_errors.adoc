...
Binding to target org.springframework.boot.context.properties.bind.BindException: Failed to bind properties under 'token.issuer' to eu.ecodex.connector.security.container.service.TokenIssuerFactoryProperties failed:
