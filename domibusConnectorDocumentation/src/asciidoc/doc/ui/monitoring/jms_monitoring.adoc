...
A description on how the internal message queues are used, see the description of link:{basepath}/doc/architecture/message_processing/message_processing.html[message processing].
