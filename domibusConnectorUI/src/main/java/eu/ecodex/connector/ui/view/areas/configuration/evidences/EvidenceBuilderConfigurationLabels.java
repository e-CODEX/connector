...
/**
 * The {@code EvidenceBuilderConfigurationLabels} class represents a collection of configuration
 * labels used in evidence builder configurations. Each label provides descriptive information about
 * a specific configuration element, such as its name, purpose, and usage.
 */
@UtilityClass
public class EvidenceBuilderConfigurationLabels {
    public static final ConfigurationLabel evidenceTimoutActiveLabels = new ConfigurationLabel(
        ...
        "Used to turn on/off the check if evidences for outgoing messages have been "
            + "received ",
        "within configured time periods. Please see also the next few configuration settings."
    );
    ...
    public static final ConfigurationLabel relayTimoutLabels = new ConfigurationLabel(
        ...
        "After this period, if no RelayREMMD evidence was received for a successfully "
    ...
    public static final ConfigurationLabel deliveryTimoutLabels = new ConfigurationLabel(
        ...
        "After this period, if no Delivery/Non-Delivery evidence was received for a "
            + "successfully sent outgoing message, ",
    ...
    public static final ConfigurationLabel retrievalTimoutLabels = new ConfigurationLabel(
        ...
        "After this period, if no Retrieval/Non-Retrieval evidence was received for a "
            + "successfully sent outgoing message, ",
    ...
    public static final ConfigurationLabel endpointAddressLabels = new ConfigurationLabel(
        ...
        "This value will be put into generated evidences. It tells the address of the "
            + "sending gateway. ",
        "This value should match the endpoint address that is contained within the PModes. ",
        "When importing the PModes the address of the home gateway is tried to be resolved and "
            + "set here."
    );
    public static final ConfigurationLabel gatewayNameLabels = new ConfigurationLabel(
        "Name of the home gateway",
        "gateway.name",
        "This value will be put into generated evidences. It tells the name of the "
            + "sending gateway. ",
        "This value should match the name that is contained within the PModes. ",
        "When importing the PModes the name of the home gateway is tried to be resolved and set "
            + "here."
    );
    public static final ConfigurationLabel postalAddressStreetLabels = new ConfigurationLabel(
        "Postal address - Street/Number",
        "postal.address.street",
        "This value will be put into generated evidences. It is part of the  postal "
            + "address mentioned in evidences. "
    );
    ...
    public static final ConfigurationLabel evidencesKeyStorePathLabels = new ConfigurationLabel(
        ...
        "The File-Path to the keystore holding the certificate with which generated "
            + "evidences are signed. ",
    ...
    public static final ConfigurationLabel evidencesKeyStorePasswordLabels = new ConfigurationLabel(
        ...
        "The Password of the keystore holding the certificate with which generated "
            + "evidences are signed. "
    );
