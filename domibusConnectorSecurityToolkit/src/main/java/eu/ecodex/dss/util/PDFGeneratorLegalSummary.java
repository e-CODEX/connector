...
public class PDFGeneratorLegalSummary extends AbstractPDFGenerator {
    ...
    private void addStamp(final com.lowagie.text.Document document, final Token token) throws DocumentException {
        ...
        switch (trustlevel) {
            case SUCCESSFUL:
                trustImage = IMG_LEGAL_SUCCESSFULL;
                break;
            default:
                trustImage = IMG_LEGAL_NOTSUCCESSFULL;
                break;
        }
        ...
        leftCell.addElement(new Paragraph(
                "Further details can be found in the attached validation report and its technical assessment.",
                FONT_FOOTER
        ));
