...
@SpringBootTest(
        classes = {ListMessagesInQueueTest.MyTestContext.class}, properties = {"spring.liquibase.enabled=false"}
)
...
class ListMessagesInQueueTest {
    ...
    void it_is_possible_to_retrieve_all_messages_that_are_on_the_dlq() throws JMSException {
        ...
        // Assert
        final DomibusConnectorMessage domainMsg =
                (DomibusConnectorMessage) converter.fromMessage(messages.get(0)); // convert jms to domain msg
