...
Upgrade manual: link:../upgrade/upgrade-4.3.0.html#upgrade-4.3.0[Upgrade to 4.3.0]

* Multiple improvements on the message flow to prevent deadlocks, improve performance
* JTA integrated
...
* New DB Scripts for (please also consult the test-matrix: link:../versioning_and_compatibility/testing_matrix.html#testing-matrix[Test Matrix]), (higher Major Versions might work)
** MariaDB 10.3
** Postgresql >= 13.2
** Mysql 8, >= 5.6.6
** Oracle 11g
