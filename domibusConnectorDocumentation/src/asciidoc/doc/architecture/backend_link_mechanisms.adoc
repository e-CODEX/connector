...
link:{basepath}/doc/configuration/link_doc.html[Link Configuration Manual]
...
link:{basepath}/doc/ui/monitoring/message_transport_overview.html[Message Transport to Link Partners]
