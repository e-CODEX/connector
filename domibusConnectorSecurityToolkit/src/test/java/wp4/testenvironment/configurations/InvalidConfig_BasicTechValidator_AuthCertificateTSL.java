...
public class InvalidConfig_BasicTechValidator_AuthCertificateTSL {
	...
	private static String Path_to_RandomXML = "src/test/resources/tsl/invalid_testentries/Formsheet_A_sample1.xml";
	private static String Path_to_RandomFile = "src/test/resources/tsl/invalid_testentries/Attachment2.bmp";
	private static String Path_to_LOTL_with_RandomFile = "src/test/resources/tsl/invalid_testentries/LOTL_RandomXML.xml";
	private static String Path_to_LOTL_with_RandomXML = "src/test/resources/tsl/invalid_testentries/LOTL_RandomFile.xml";
