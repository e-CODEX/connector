...
| The Location of the Etsi Validation Policy. This policy is used by the DSS Utils to verify the certificate of the attached signature on the business document.
| TextField
...
| Checkbox
a| * set (true): the following properties define the TrustStore used for verification.
...
| Checkbox
a| * set (true): the following properties define the TrustStore with certificates ignored.
