...
The signature based validation uses DSS library to validate the document signature according to the provided rules. This rules can be configured by the link:{basepath}/doc/ui/configuration/business_document_verification.adoc[Business Document Verification] configuration. The connector supports setting:
