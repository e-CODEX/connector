...
WARNING: With connector 4.3.0 this document is not valid anymore. See link:{basepath}/doc/configuration/link_doc.adoc[Link Configuration]

== Backend Configuration or how to configure a connector client?

As you can see at the link:{basepath}/doc/architecture/architecture_overview.adoc/[architectural overview] the connector can communicate with different connector clients. The decision
...
link:{basepath}/doc/configuration/backend_message_routing_configuration.adoc[Backend Message Routing] page.
'
