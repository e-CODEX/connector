...
In the end, every e-CODEX partner participating in one or more business use-cases requires use-case specific software to handle the business
...
is also on the e-CODEX website link:https://www.ecodex.eu[here].
