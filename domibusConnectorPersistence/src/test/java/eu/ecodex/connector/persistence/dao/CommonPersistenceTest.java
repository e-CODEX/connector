...
import eu.ecodex.connector.persistence.testutil.RecreateDbByLiquibaseTestExecutionListener;
import eu.ecodex.connector.persistence.testutil.SetupPersistenceContext;
...
@TestPropertySource(
    properties = {
        "connector.persistence.big-data-impl-class=eu.ecodex.connector.persistence.service.impl.DomibusConnectorBigDataPersistenceServiceJpaImpl",
