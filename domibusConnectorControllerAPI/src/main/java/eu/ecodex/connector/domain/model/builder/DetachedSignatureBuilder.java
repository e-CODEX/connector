...
/**
 * Builder for @see eu.ecodex.connector.domain.model.DetachedSignatureBuilder
 *
...
public final class DetachedSignatureBuilder {
    ...
    /**
     * The signature @see
     * eu.ecodex.connector.domain.model.DetachedSignatureBuilder#detachedSignature
     *
    ...
    /**
     * The name @see
     * eu.ecodex.connector.domain.model.DetachedSignatureBuilder#detachedSignatureName
     *
     * @param name - the name
     * @return the builder
     */
    ...
    /**
     * the mimeType @see eu.ecodex.connector.domain.model.DetachedSignatureBuilder#mimeType
     *
