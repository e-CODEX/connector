...
public class JaxbContextHolder {
     ...
     */
    public static javax.xml.bind.JAXBContext getSpocsJaxBContext() throws JAXBException {
        if (spocsContext == null) {
            spocsContext = JAXBContext.newInstance(
    ...
    public static javax.xml.bind.JAXBContext getSoapBindingJaxBContext() throws JAXBException {
        if (soapContext == null) {
            soapContext = JAXBContext.newInstance(org.etsi.uri._02640.soapbinding.v1_.ObjectFactory.class);
        }
        return soapContext;
    }
	...
	*/
     ...
     * @throws JAXBException In case of errors creating the JAXB context.
     */
    public static javax.xml.bind.JAXBContext getETSIV2JaxBContext() throws JAXBException {
        if (etsi_vi == null) {
            etsi_vi = JAXBContext.newInstance(org.etsi.uri._02640.v2.ObjectFactory.class);
        }
        return etsi_vi;
    }
}
