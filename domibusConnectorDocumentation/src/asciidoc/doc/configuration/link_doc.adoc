...
This document describes how these links are configured with properties. The UI configuration manual is link:../ui/linkconfig/link_configuration.html[here] available.
