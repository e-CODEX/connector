...
/**
 * Register a business domain property source.
 */
public class RegisterBusinessDomainPropertySource
    implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    private static final Logger LOGGER =
        LogManager.getLogger(RegisterBusinessDomainPropertySource.class);
