...
As the security lib configuration has been split into the eCodexContainer and BusinessDocumentVerification configuration the following properties have changed:

More details are available here:

* link:../ui/configuration/business_document_verification.html#business-document-verification-configuration[Business Document UI configuration]

* link:../ui/configuration/ecodex_container_configuration.html#container-configuration[eCodex Container UI configuration]

* link:../architecture/ecodex_container_creation.html#ecodex-container-creation[eCodex container creation]
...
* Re-upload p-Modes and trusted connectors keystore.
