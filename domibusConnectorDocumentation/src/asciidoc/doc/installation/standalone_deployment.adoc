...
=== Starting
The standalone package is ready to run. Everything es preconfigured, even an embedded database is spinning up during startup.
...
create an own user for operating it.
