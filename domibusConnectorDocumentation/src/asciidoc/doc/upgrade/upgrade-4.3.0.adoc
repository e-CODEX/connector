...
link:{basepath}/doc/configuration/link_doc.html[Connector Link Manual]
...
For details see: link:{basepath}/doc/architecture/backend_message_routing.html[Backend Message Routing]
