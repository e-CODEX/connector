...
public class PDomibusConnectorTransportStepStatusUpdate {
    ...
    public TransportState getTransportState() {
        return TransportStateJpaConverter.converter.convertToEntityAttribute(this.transportStateString);
    }

    public void setTransportState(TransportState transportState) {
        this.transportStateString = TransportStateJpaConverter.converter.convertToDatabaseColumn(transportState);
    }
