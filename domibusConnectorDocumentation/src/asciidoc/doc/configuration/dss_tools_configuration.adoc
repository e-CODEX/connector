...
A trust source can contain multiple Lists of Trusted List (LOTL) or trusted lists (TL). The name of the trust source can be used within the link:ui/configuration/business_document_verification.html#business-document-verification-configuration[business document validation configuration].
