...
public class WebConnectorTestServiceConfiguration {
    ...
    //it might be possible, if the testbackend plugin is not enabled, that the service DCConnector2ConnectorTestService is not available!, in this case do not create WebConnectorTestService bean.
    @Bean
    @ConditionalOnBean({DCConnector2ConnectorTestService.class, ConnectorTestConfigurationProperties.class})
    public WebConnectorTestService webConnectorTestService(DCConnector2ConnectorTestService testService,
