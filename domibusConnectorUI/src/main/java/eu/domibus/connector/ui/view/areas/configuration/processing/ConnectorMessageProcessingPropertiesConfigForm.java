...
public class ConnectorMessageProcessingPropertiesConfigForm extends FormLayout {
    ...
    private final Select<ConnectorMessageProcessingProperties.PModeVerificationMode> outgoingPModeVerificationMode;
    private final Select<ConnectorMessageProcessingProperties.PModeVerificationMode> incomingPModeVerificationMode;

    public ConnectorMessageProcessingPropertiesConfigForm() {

        outgoingPModeVerificationMode =
                new Select<>(ConnectorMessageProcessingProperties.PModeVerificationMode.values());
