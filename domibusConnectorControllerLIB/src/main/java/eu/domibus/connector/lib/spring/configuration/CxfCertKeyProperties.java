...
public abstract class CxfCertKeyProperties {
    ...
    public Properties mapCertAndStoreConfigPropertiesToMerlinProperties() {
        ...
        try {
            // TODO: fix this
            // p.setProperty("org.apache.wss4j.crypto.merlin.keystore.file", this.getPrivateKey().getStore()
            // .getPathUrlAsString());
        } catch (Exception e) {
        ...
        try {
            ...
            // TODO: fix this
            // p.setProperty("org.apache.wss4j.crypto.merlin.truststore.file", this.getTrust().getStore()
            // .getPathUrlAsString());
        } catch (Exception e) {
            LOGGER.info(
                    "Trust Store Property: [" + getPrefix() + ".trust.store.path]" +
    ...
    public static class KeyAndKeyStoreConfigurationProperties {
        ...
        public KeyAndKeyStoreConfigurationProperties(
                StoreConfigurationProperties keyStore,
