...
public class JmsConfiguration {
    ...
    ArtemisConfigurationCustomizer artemisCustomizer(QueuesConfigurationProperties prop) {
        return configuration -> {
            ...
            configuration.getAddressesSettings().put(prop.getToLinkQueue(), addressSettings1);
            ...
            configuration.getAddressesSettings().put(prop.getToConnectorControllerQueue(), addressSettings2);
            ...
            configuration.getAddressesSettings().put(prop.getCleanupQueue(), addressSettings3);
            ...
            configuration.getAddressesSettings().put(QueuesConfigurationProperties.DLQ_PREFIX + "#", dlqAdressSettings);
        };
    }
