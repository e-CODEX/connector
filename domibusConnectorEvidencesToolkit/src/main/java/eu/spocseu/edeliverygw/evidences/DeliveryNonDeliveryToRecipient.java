...
public class DeliveryNonDeliveryToRecipient extends Evidence {
    private static Logger LOG = LoggerFactory.getLogger(DeliveryNonDeliveryToRecipient.class);
    ...
    public DeliveryNonDeliveryToRecipient(
            EDeliveryDetails details, InputStream deliveryNonDeliveryInpStream) throws SpocsWrongInputDataException {
        try {
            ...
            throw new SpocsWrongInputDataException("Error reading the DeliveryNonDeliveryToRecipient xml stream.", ex);
        }
    }
     ...
     */
    public DeliveryNonDeliveryToRecipient(EDeliveryDetails details, Evidence submissionAcceptanceRejection) {
        super(details);
    ...
    // klara
    public DeliveryNonDeliveryToRecipient(
            EDeliveryDetails details, Evidence submissionAcceptanceRejection, EventReasonType eventReson) {
        super(details);
        init(details, submissionAcceptanceRejection, false);
        super.setEventReason(eventReson);
    }
     ...
     * @param details                       Configuration object to set some properties
     * @param submissionAcceptanceRejection The previous SubmissionAcceptanceRejection
     * @param isDelivery                    If this value is false a fault evidence event will be set.
     */
    public DeliveryNonDeliveryToRecipient(
    ...
    public void serialize(OutputStream out) throws JAXBException {
        JaxbContextHolder.getSpocsJaxBContext().createMarshaller()
                         .marshal(new ObjectFactory().createDeliveryNonDeliveryToRecipient(jaxbObj), out);
    }
