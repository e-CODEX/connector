...
public abstract class AbstractPDFGenerator {
    ...
    static {
        try {
            ...
            FONT_H2 = new Font(Font.HELVETICA, 12, Font.BOLD);
    ...
    /**
     * Adds a page header to the provided PDF document. The header includes an image
     * logo and is positioned at the top of the page with specific alignment and padding settings.
     *
     * @param document The PDF document to which the header will be added.
     * @param token The token containing contextual or session-related information.
