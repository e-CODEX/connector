...
public abstract class ECodexContainerFactoryServiceITCaseTemplate {
    ...
    public void createContainerFromXML(TestInfo testInfo) throws ECodexException, IOException {
        ECodexContainerService eCodexContainerService =
                getECodexContainerFactoryService().createECodexContainerService(DomainEntityCreator.createEpoMessage());

        BusinessContent businessContent = new BusinessContent();

        // bytes name mimetype
        DSSDocument businessDoc =
                loadDocumentFromResource("examples/ExampleXmlSigned.xml", "ExampleXmlSigned.xml", MimeTypeEnum.XML);
        ...
        eCodexContainerService =
                getECodexContainerFactoryService().createECodexContainerService(DomainEntityCreator.createEpoMessage());
        eCodexContainer =
                eCodexContainerService.receive(new ByteArrayInputStream(asics), new ByteArrayInputStream(tokenXml));
    }

    @Test
    @DisplayName("Build ASIC-S container with XML authentication based")
    public void createContainerFromXMLWithAuthenticationBased(TestInfo testInfo) throws ECodexException, IOException,
        ...
        ECodexContainerService eCodexContainerService =
                getECodexContainerFactoryService().createECodexContainerService(msg);
        ...
        JAXBElement<Token> jaxbToken =
                unmarshaller.unmarshal(new StreamSource(new ByteArrayInputStream(tokenXml)), Token.class);
    ...
    public void createContainerFromAsicS(TestInfo testInfo) throws ECodexException, IOException {
        ...
        // bytes name mimetype
        DSSDocument businessDoc =
                loadDocumentFromResource("examples/ExampleAsics.asics", "ExampleAsics.asics", MimeTypeEnum.ASICS);
        businessContent.setDocument(businessDoc);
    ...
    @Test
    public void simpleTestCreateContainerServiceAndBuildAsicContainer(TestInfo testInfo) throws ECodexException,
            IOException {
        ECodexContainerService eCodexContainerService =
                getECodexContainerFactoryService().createECodexContainerService(DomainEntityCreator.createEpoMessage());
    ...
    //    public void simpleTestCreateContainerServiceAndBuildAsicContainer_withStreams() throws IOException,
    //    ECodexException {
    //
    //        //securityContainerService.create()
    //
    //        ECodexContainerService eCodexContainerService = getECodexContainerFactoryService()
    //        .createECodexContainerService(null);
    //
    //        BusinessContent businessContent = new BusinessContent();
    //
    //        //bytes name mimetype
    ...
    //        businessContent.addAttachment(dssDocument);
    //
    //        ECodexContainer eCodexContainer = eCodexContainerService.create(businessContent, tokenIssuerFactory
    //        .getTokenIssuer(null));
    //
    //    }
    ...
    private InMemoryDocument loadDocumentFromResource(String classpathResource, String name, MimeType mimeType) throws
            IOException {
