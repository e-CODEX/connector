...
public class CreateLinkPartnerStep extends DCLinkPartnerField implements WizardStep {
    ...
    public CreateLinkPartnerStep(ApplicationContext applicationContext,
        ...
        super(applicationContext, springBeanValidationBinderFactory, linkManagerService, configurationPropertyCollector);
    }
