...
public class ConnectorTestConfigurationProperties {
    ...
    private Resource defaultBusinessXml =
            new ClassPathResource("/eu/domibus/connector/config/c2ctests/testbusinessxml.xml");
    @NotNull
    private Resource defaultBusinessPdf =
            new ClassPathResource("/eu/domibus/connector/config/c2ctests/testbusinesspdf.pdf");
    @Valid
    private EvidenceActionServiceConfigurationProperties.AS4Service service =
            new EvidenceActionServiceConfigurationProperties.AS4Service("Connector-TEST", "urn:e-codex:services:");
    @Valid
    @NotNull
