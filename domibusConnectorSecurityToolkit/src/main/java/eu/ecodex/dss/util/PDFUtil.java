...
public class PDFUtil {
    ...
    public static String format(final XMLGregorianCalendar cal) {
        ...
        final var date = cal.toGregorianCalendar().getTime();
    ...
    public static int getPageCount(final DSSDocument document) {
        ...
        try (var pdfReader = new PdfReader(document.openStream())) {
    ...
    private static boolean hasPDFContent(final DSSDocument document, boolean checkPageCount) {
        ...
        try (var reader = new PdfReader(document.openStream())) {
     ...
     *
     * <p>If the document is empty , it's ignored. If all documents are empty, it's not possible to
     * create the document. All the documents should be a PDF file.
     *
    ...
    public static DSSDocument concatenate(final String filename, final DSSDocument... documents)
        ...
        // used further below
        final var sourceReaders = new ArrayList<PdfReader>();
        ...
        final var targetDoc = new com.lowagie.text.Document();
